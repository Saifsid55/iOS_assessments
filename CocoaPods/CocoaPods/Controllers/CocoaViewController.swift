...
extension CocoaViewController: UITableViewDataSource,
                                      UITableViewDelegate {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        if let cell = photoAthortableView.dequeueReusableCell(withIdentifier: "CocoaTableViewCell") as? CocoaTableViewCell {
